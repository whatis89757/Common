...
public class SettingsXmlParser {
    ...
    private static final String TAG = SettingsXmlParser.class.getSimpleName();
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.END_TAG:
                        if ("setting".equals(xmlResParser.getName())) {
                            ...
                            Log.d(TAG, String.format("parse new setting --->%s", gson.toJson(readSetting)));
                            readSetting = null;
                        }

                        if ("setting-array".equals(xmlResParser.getName())) {
                            settingArray.add(readSettingArray);
                            Log.d(TAG, String.format("parse new settingArray --->%s", gson.toJson(readSettingArray)));
                        ...
                        if ("extra".equals(xmlResParser.getName())) {
                            ...
                            Log.d(TAG, String.format("parse new settingExtra --->%s", gson.toJson(settingExtras)));
